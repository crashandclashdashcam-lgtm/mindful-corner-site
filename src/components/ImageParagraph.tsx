  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      ...
      <div className="absolute top-0 left-0 w-full h-32 overflow-hidden opacity-30">
        <div className="absolute w-2 h-2 bg-primary rounded-full" style={{ top: "10%", left: "15%", animation: "float 3s ease-in-out infinite" }} />
        <div className="absolute w-1 h-1 bg-primary rounded-full" style={{ top: "30%", left: "25%", animation: "float 4s ease-in-out infinite 0.5s" }} />
        <div className="absolute w-3 h-3 bg-primary rounded-full" style={{ top: "20%", left: "35%", animation: "float 3.5s ease-in-out infinite 1s" }} />
        <div className="absolute w-2 h-2 bg-primary rounded-full" style={{ top: "40%", left: "45%", animation: "float 4.5s ease-in-out infinite 1.5s" }} />
        <div className="absolute w-1 h-1 bg-primary rounded-full" style={{ top: "15%", left: "55%", animation: "float 3s ease-in-out infinite 2s" }} />
      </div>
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative h-[600px]">
            {/* Image 1 - Bottom left */}
            <div 
              className="absolute bottom-0 left-0 w-64 h-80 rounded-2xl overflow-hidden shadow-2xl border-4 border-white hover-scale z-10"
            ...
            {/* Image 2 - Top center */}
            <div 
              className="absolute top-0 left-1/2 -translate-x-1/2 w-72 h-96 rounded-2xl overflow-hidden shadow-2xl border-4 border-white hover-scale z-20"
            ...
            {/* Image 3 - Right side */}
            <div 
              className="absolute top-32 right-0 w-64 h-72 rounded-2xl overflow-hidden shadow-2xl border-4 border-white hover-scale z-10"
              style={{ transform: "rotate(-3deg)" }}
            >
              <img 
                src={therapyImage} 
